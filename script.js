...
// NOVA sales CTA configuration — replace once with your real Gumroad product URL.
window.NOVA_PRODUCT_URL = 'https://gumroad.com/REPLACE_WITH_YOUR_PRODUCT';
document.querySelectorAll('a[href*="REPLACE_WITH_YOUR_PRODUCT"]').forEach(a => a.href = window.NOVA_PRODUCT_URL);
